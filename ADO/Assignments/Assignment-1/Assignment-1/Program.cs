...
namespace Assignment_1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Employee.DisplayEmployees(employeesJoinedBefore2015);
            ...
            Employee.DisplayEmployees(employeesBornAfter1990);
            ...
            Employee.DisplayEmployees(consultantOrAssociateEmployees);
            ...
            DateTime youngestDOB = empList.Max(emp => emp.DOB);
            ...
            Employee.DisplayEmployees(youngestEmployees);
